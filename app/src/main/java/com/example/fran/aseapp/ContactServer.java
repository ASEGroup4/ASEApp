...
public class ContactServer extends IntentService  {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String urlString = "http://user.sussex.ac.uk/~sl410/ase/index.php?AppKey=4seGroup4.&locationLat=" + locationLat + "&locationLong=" + locationLong+"&id=" + android_id + "&time=" + strDate;
        try {
